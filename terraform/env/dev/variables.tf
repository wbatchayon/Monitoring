...
variable "monitoring_network" {
  description = "Monitoring network base (e.g., 192.168.1.0)"
  type        = string
  default     = "192.168.1"
}
...
variable "prometheus_ip" {
  description = "Prometheus VM IP address (last octet)"
  type        = string
  default     = "110"
}

variable "elk_ip" {
  description = "ELK VM IP address (last octet)"
  type        = string
  default     = "111"
}

variable "grafana_ip" {
  description = "Grafana VM IP address (last octet)"
  type        = string
  default     = "112"
}

variable "zabbix_ip" {
  description = "Zabbix VM IP address (last octet)"
  type        = string
  default     = "113"
}
